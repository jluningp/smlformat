structure CommentParser = struct
  structure ParseInfo = struct
    ...
    fun commentEnded
        ...
        , inStringLiteral = inStringLiteral
        , currentComment = currentComment
        , comments = insertMultiMap comments currentLineNumber (currentComment, currentColumnNumber - 1)
        , currentLineNumber = currentLineNumber
        , currentColumnNumber = currentColumnNumber
        }
    ...
    fun toString
        ...
        ^ ") (comments [opaque]) (currentLineNumber " ^ Int.toString currentLineNumber
        ^ ") (currentColumnNumber " ^ Int.toString currentColumnNumber ^ "))"
  end
